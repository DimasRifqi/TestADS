...
@section('content')
    <div class="hero_area">
        ...
        <div class="bg-box">
            <img src="{{ asset('asset_produk/images/hero-bg.jpg') }}" alt="">
        </div>
            ...
            <div class="container ">
                <div class="row">
                    <div class="col-md-6  ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="{{ asset('asset_produk/images/o1.jpg') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Tasty Thursdays
                    ...
                    <div class="col-md-6  ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="{{ asset('asset_produk/images/o2.jpg') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Pizza Days
                                ...
                                <div>
                                    ...
                                    <div class="detail-box">
                                        ...
                                        <div class="options">
                                            ...
                                            <form action="{{ route('keranjang.create') }}" method="POST">
                                                @csrf
    ...
    <section class="about_section layout_padding">
        <div class="container  ">
            ...
            <div class="row">
                <div class="col-md-6 ">
                    <div class="img-box">
                        <img src="{{ asset('asset_produk/images/about-img.png') }}" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="detail-box">
                ...
                <div class="owl-carousel client_owl-carousel">
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="img-box">
                                <img src="{{ asset('asset_produk/images/client1.jpg') }}" alt=""
                                    class="box-img">
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="img-box">
                                <img src="{{ asset('asset_produk/images/client2.jpg') }}" alt=""
                                    class="box-img">
                            </div>
                        </div>
                    </div>
